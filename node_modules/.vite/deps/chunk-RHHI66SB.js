...
function useRootElementName(parameters) {
  ...
  const updateRootElementName = React8.useCallback((instance) => {
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React47.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React47.useMemo(() => {
    return {
      min: min3,
      max: max3,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React47.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var InnerOption = React52.memo(React52.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React52.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
var Slider = React56.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime33.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime32.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime32.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime33.jsxs)(React56.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RHHI66SB.js.map
